# Enterprise Course Catalog: OPENLXP-XIA-edX
...
# Workflows
The edX XIA implements six core workflows, as follows:
...
1. Clone the Github repository:
    ...
    https://github.com/OpenLXP/openlxp-xia-edx.git

2. Open terminal at the root directory of the project.
    
    example: ~/PycharmProjects/openlxp-xia-edx
...
`xsr_api_endpoint`: Add API endpoint for edx metadata

`token_url`: Add edX token to access metadata

`edx_client_id`: Add edX client ID to access metadata

`edx_client_secret`:Add edx client password to access metadata
