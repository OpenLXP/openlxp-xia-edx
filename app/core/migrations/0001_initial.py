# Generated by Django 3.1.10 on 2021-05-06 16:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete_email_address', models.EmailField(help_text='Enter email address of personas to who no longer want to receive the log emails', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email_address', models.EmailField(help_text='Enter email personas addresses to send log data', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='MetadataLedger',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('publisher', models.CharField(default='edX', help_text='Enter the source file to extract data from.', max_length=200)),
                ('source_metadata_schema', models.CharField(default='edX_source_validate_schema.json', help_text='Enter the edX schema file', max_length=200)),
                ('source_target_mapping', models.CharField(default='edX_p2881_target_metadata_schema.json', help_text='Enter the schema file to map target.', max_length=200)),
